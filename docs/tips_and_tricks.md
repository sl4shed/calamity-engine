...
For more information regarding tracy usage, please take a look at it's [documentation](https://github.com/wolfpld/tracy/releases/latest/download/tracy.pdf) (which is a PDF file :)).
